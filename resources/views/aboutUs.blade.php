...
<section class="story-section">
 ...
 <div class="section-heading">Our Mission, Values, and Vision</div>
  ...
  <div class="mission-text text-center px-3">
    <p>
      ...
      Our unwavering commitment to both our customers, franchise partners & distributors is the key to our success in the future.
      We are dedicated to creating a dynamic environment, conducting ourselves with the highest integrity for every component in our value chain:
      our customers, suppliers, team members, and franchise partners. By acting in the best interest of everyone along our value chain,
      we are able to ensure our company’s sweet success.
    </p>
  </div>

  <!-- Core Values -->
  <div class="core-values px-3">
    <div class="core-title">Our Core values are</div>
    <ol>
      <li>
        All our products and services shall be offered with the same love, care, and affection as if,
        they were meant for the most beloved person.
      </li>
      <li>
        Being fair to all our customers, stakeholders and business partners, suppliers and employees.
        For we believe good intentions yield good products & services is to make Monginis living proof that
        hard-work, integrity, innovation, and continued support can lead to all levels of success.
      </li>
    </ol>
  </div>
  ...
  <div class="mission-statement px-3">
    ...
    <p><strong>Our mission</strong> is to offer gourmet cakes, pastries, cupcakes, cookies, and more that are universally enjoyed
      by family and friends and make Monginis a part of all life’s celebrations and memories.</p>
  </div>
  <div class="container-custom">
    ...
    <div class="icon-text-row">
      ...
      <p class="text-content">
        <strong>Our Core</strong> purpose is to help people express their happiness in a memorable way.
      </p>
    </div>
    ...
    <div class="icon-text-row">
      ...
      <p class="text-content">
        <strong>Our Passion</strong> Cakes are not just our business, they are our passion. Our Gateaux, Pastries,
        cupcakes, swiss rolls, and savories are all baked and prepared with the same love, care, and affection that
        would go into preparing for our own friends and family. To us, the cakes and pastries that go out into the
        market are not merely our product line, but are our way to bring something we love into our customers’ homes.
      </p>
    </div>
