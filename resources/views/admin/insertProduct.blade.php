            ...
            <div class="form-container p-4 bg-white shadow rounded-4">
                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control form-control-lg rounded-3" placeholder="Enter product title" required>
                        @error('title')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="price" name="price" value="{{ old('price') }}" class="form-control form-control-lg rounded-3" placeholder="Enter price" required>
                            @error('price')
                                <div class="text-danger small mt-1">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="category_id" id="category_id" class="form-select form-control-lg rounded-3" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="file" id="image" name="image" class="form-control form-control-lg rounded-3" required>
                            @error('image')
                                <div class="text-danger small mt-1">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea id="description" name="description" rows="4" class="form-control form-control-lg rounded-3" placeholder="Enter product description">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="text-danger small mt-1">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-actions mt-4">
                        <button type="submit" class="btn w-100 btn-lg rounded-3 shadow" style="background-color: #6f42c1; color: white;">
                            Insert Product
                        </button>
                    </div>
                </form>
