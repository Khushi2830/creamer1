        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="dashboard-header d-flex justify-content-between align-items-center mb-4">
                    <h2 class="page-title mb-0" style="color: #5369c0;" >Insert Blog</h2>
                ...
                <div class="form-container p-4 bg-white shadow rounded-4">
                    <form action="{{ route('blog.store') }}" method="POST" class="custom-form" enctype="multipart/form-data">
                        @csrf
                          ...
                          <div class="col-md-6 mb-3">
                            <div class="form-group mb-3">
                               <label for="title" class="form-label fw-semibold">Blog Title</label>
                                <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control form-control-lg rounded-3" placeholder="Enter blog title">
                                @error('title')
                           ...
                           <div class="col-md-6 mb-3">
                              <div class="form-group mb-3">
                                 ...
                                 <input type="text" id="title" name="author" value="{{ old('author') }}" class="form-control form-control-lg rounded-3" placeholder="Enter blog author">
                                  @error('author')
                                   <div class="form-error text-danger small mt-1">{{$message}}</div>
                                  @enderror
                                 </div>
