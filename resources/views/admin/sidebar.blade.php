  ...
  <div class="sidebar">
    ...
    <a href="#" class="menu-item active m-2"><i class="fas fa-fire"></i> Dashboard </a>
    <div class="submenu">
       <a href="#" class="menu-item"><i class="fas fa-award"></i> Manage Category</a>
    <a href="#" class="menu-item"><i class="fas fa-layer-group"></i> Manage Product</a>
