                ...
                <table class="table table-striped align-middle table-hover mb-0">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>{{$blog->content}}</td>
                            <td>
                                <img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title }}" class="blog-image" width="100px">
                            </td>
                            <td class="">
                                <div class="action-buttons d-flex gap-2 ">
                                        <form method="post" action="{{ route('blog.destroy', $blog) }}" class="delete-form">
                                            @csrf
                                            @method("delete")
                                            <button type="submit" class="btn btn-sm" style="background-color: blueviolet; color: white;" title="Delete blog">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                                                <span>Delete</span>
                                            </button>
                                        </form>
                                        <button type="" class="btn btn-sm" style="background-color: blueviolet; color: white;" title="Edit blog">
